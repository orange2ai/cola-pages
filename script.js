const copy = {
  en: {
    ...
    featuresEyebrow: 'Four small switches', featuresTitle: 'Keep the posts. Make room for attention.',
    ...
    whyEyebrow: 'Why Clean X Up', whyTitle: 'You came for the conversation.',
    whyBody: 'Clean X Up gives the interface a little more silence, so the things you chose to read can stay in view.',
    closingEyebrow: 'Make it yours', closingTitle: 'A little more room to read.',
  ...
  zh: {
    ...
    featuresEyebrow: '四个小开关', featuresTitle: '留下内容，也留一点注意力。',
    ...
    whyEyebrow: '为什么是 Clean X Up', whyTitle: '你打开 X，是为了看见一些真正想看的东西。',
    whyBody: 'Clean X Up 给界面留出一点安静，让你选择留下的内容好好待在视线里。',
    closingEyebrow: '按你的方式使用', closingTitle: '给阅读留一点空间。',,
